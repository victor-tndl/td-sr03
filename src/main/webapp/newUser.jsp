...
<body>
	<form action="userValidation" method="post">
		...
		<label> male </label> <input type="radio" id="male" name="gender" value="gender" checked/><br>
		<label> female </label> <input type="radio" id="female" name="gender" value="gender"/> <br>
